...
class bakes_and_cakes_Social_Links extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        if( $facebook || $twitter ||  $linkedin || $instagram || $google_plus || $pinterest || $youtube || $ok || $vk || $xing || $tiktok ){ 
        ...
        ?>
            <ul class="social-networks">
                ...
                <?php } if( $tiktok ){ ?>
                <li><a href="<?php echo esc_url( $tiktok ); ?>" target="_blank" title="<?php esc_attr_e( 'Tiktok', 'bakes-and-cakes' ); ?>"><i class="fab fa-tiktok"></i></a></li>
                <?php } ?>
			</ul>
        <?php
	...
	public function form( $instance ) {
        ...
        $vk          = ! empty( $instance['vk'] ) ?  $instance['vk'] : '' ;
        $xing    	 = ! empty( $instance['xing'] ) ?  $instance['xing'] : '' ;
        $tiktok   	 = ! empty( $instance['xing'] ) ?  $instance['tiktok'] : '' ;
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'tiktok' )); ?>"><?php _e( 'Tiktok', 'bakes-and-cakes' ); ?></label> 
