...
function classic_bakery_theme_info_menu_link() {
	...
	$theme = wp_get_theme();
	add_theme_page(
		sprintf( esc_html__( 'Welcome to %1$s %2$s', 'classic-bakery' ), $theme->display( 'Name' ), $theme->display( 'Version' ) ),
...
<div class="wrap theme-info-wrap">
	<h1><?php printf( esc_html__( 'Welcome to %1$s %2$s', 'classic-bakery' ), esc_html($theme->display( 'Name', 'classic-bakery'  )),esc_html($theme->display( 'Version', 'classic-bakery' ))); ?>
	</h1>
	...
	<div id="getting-started">
		...
		esc_html($theme->display( 'Name', 'classic-bakery' ))); ?></h3>
		<div class="columns-wrapper clearfix">
			...
			<div class="column column-half clearfix">
				...
				<div class="section">
					...
					<p class="about">
					<?php printf( esc_html__( '%s makes use of the Customizer for all theme settings. Click on "Customize Theme" to open the Customizer now.', 'classic-bakery' ),esc_html($theme->display( 'Name', 'classic-bakery' ))); ?></p>
					<p>
	...
	<div id="theme-author">
	  <p><?php
		printf( esc_html__( '%1$s is proudly brought to you by %2$s. If you like this theme, %3$s :)', 'classic-bakery' ),
			esc_html($theme->display( 'Name', 'classic-bakery' )),
